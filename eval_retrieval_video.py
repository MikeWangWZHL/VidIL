...
import utils
from data.video_eval_dataset import VideoDatasetEvalRetrieval
...
def main(args, config):
    ...
    test_dataset = VideoDatasetEvalRetrieval(config['video_root'],config['test_ann_jsonl'],num_frm=config['num_frm_test'],
