...
PROMPT_OUTPUT_DIR="$OUTPUT_DIR/input_prompts_caption_in_context_selection"
...
# generate prompt
OUTPUT_NAME="gpt3_queries_${DATASET}_${SPLIT}_${PROMPT_TASK}_with_in_context_selection_${VISUAL_TOKENIZATION_ENCODER}_shot_${SHOT}_seed_${RANDOM_SEED}_N_${N}.jsonl"
