...
### config ### 
DATASET=$1 # Youcook2, Vatex
SPLIT=$2
OUTPUT_ROOT_DIR=$3
SHARED_DATASETS="shared_datasets" # path to shared_datasets
...
PROMPT_OUTPUT_DIR="$OUTPUT_DIR/input_prompts_add_asr"
...
# generate prompt
OUTPUT_NAME="gpt3_queries_${DATASET}_${SPLIT}_${PROMPT_TASK}_${VISUAL_TOKENIZATION_ENCODER}_asr.jsonl"
